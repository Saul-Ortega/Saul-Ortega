...
Oriented to the Java and Spring Boot ecosystem with a double degree in Higher Vocational Training in Multiplatform Applications Development and Finance and Administration.

### 🌵 About Me

***

- 💼 Looking for a new environment where I could contribute and keep growing in my professional career.

- 🍀 Enjoy building from scratch and creating solutions that solves real-life problems.
...
[![Lombok](https://img.shields.io/badge/Lombok-C21325?style=for-the-badge&logo=Lombok&logoColor=fff)](#)
...
[![Mockito](https://img.shields.io/badge/Mockito-C21325?style=for-the-badge&logo=Mockito&logoColor=fff)](#)
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <h3>🏦 <a href="https://github.com/Saul-Ortega/Spanish-Banks-Public-Quarter-Info">Spanish Banks Public Quarter Info</a></h3>
      <p>Automated scraper and REST API for Spanish bank's quarterly financial data. Built with Java, Spring Boot, Typescript, Puppeteer, PostgreSQL and Docker.</p>
    </td>
    <td width="50%" valign="top">
      <h3>⚙️ <a href="https://github.com/Saul-Ortega/AeApplicationManager">AeApplicationManager</a></h3>
      <p>Desktop app built with C++ and Qt to manage multiple software versions, track favourites and filter applications in list or grid views.</p>
    </td>
  </tr>
</table>
